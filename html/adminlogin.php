			...
			<div class="row">
					<div class="col-6 offset-3 bg-light pt-4 mt-5" style="text-align: center; border: 10px solid white;">
						...
						<h2 style="font-family: arial"; class="alert alert-info text-white alert-sm"> ADMIN LOGIN</h2>
				<form class="form-horizontal mt-5" action="adminlog.php" method="POST">
					<div class="form-group row">
						<label for="name" class="col-md-3 col-12 mt-4 font-weight-bold" style="text-align: center;">Enter Email:</label>
							<div class="col-md-6 col-12 mt-4">
								<input type="text" name="email" class="form-control" id="adname" required>
							</div>
					</div>
					<div class="form-group row">
						<label for="password" class="col-md-3 col-12 mt-4 font-weight-bold" style="text-align: center;">Enter Password:</label>
							<div class="col-md-6 col-12 mt-4">
							<input type="password" name="password" class="form-control" id="adpassword" required >
							</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col">
							<p class="text-center">If you dont have an account? <a href="adminregister.php">Register</a> now.</p>
							<p class="text-center">Not an admin, sign in as <a href="login.php">User</a>
						</div>
					</div>
			</form>
				</div>
